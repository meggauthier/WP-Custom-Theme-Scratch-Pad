 ...
 */
function meg_register_required_plugins() {
	/**
	...
	$config = array(
		...
		'default_path' => get_stylesheet_directory() . '/plugins/advanced-custom-fields.zip',                         // Default absolute path to pre-packaged plugins */
